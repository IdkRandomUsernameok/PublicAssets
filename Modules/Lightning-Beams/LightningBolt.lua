...
local PartCache = loadstring(game:HttpGet("https://github.com/IdkRandomUsernameok/PublicAssets/raw/refs/heads/main/Modules/Lightning-Beams/PartCache/PartCache.lua"))()
